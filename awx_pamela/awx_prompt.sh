...
declare -A LIMITS=(
    ...
    [apache_dmzi_apac]="apache_dmzi_apac_apac_dev_dmzi apache_dmzi_apac_apac_stg_dmzi apache_dmzi_apac_apac_prd_dmzi"

    [apache_dmzi_emea]="apache_dmzi_emea_emea_dev_dmzi apache_dmzi_emea_emea_stg_dmzi apache_dmzi_emea_emea_prd_dmzi"
    ...
    [csa_imported_apache_dmzi_emea]="csa_imported_apache_dmzi_emea_emea_stg_dmzi csa_imported_apache_dmzi_emea_emea_prd_dmzi"
    ...
    [iis_all_windows_version]="iis_all_windows_version_emea_dev_core iis_all_windows_version_emea_stg_core iis_all_windows_version_emea_prd_core"
    ...
    [dpi_upgraded_wasnd]="dpi_upgraded_wasnd_apac_dev_core dpi_upgraded_wasnd_apac_stg_core dpi_upgraded_wasnd_apac_prd_core"
)
...
# ------------------------------------------------------------
# Helper: case-insentive validation againts a whitelist
# ------------------------------------------------------------
valid_value() {
    local val=$1; shift
    local -a allowed=("$@")
